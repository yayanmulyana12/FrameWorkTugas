                    ...
                    <div class="container mx-auto mt-5">
                        ...
                        <form action="{{ route('product-store') }}" method="POST" class="space-y-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="product_name" name="product_name" class="block w-full p-2 mt-1 border border-gray-300 rounded-md shadow-sm
                            ...
                            <div class="form-group">
                                ...
                                <select id="unit" name="unit" class="block w-full p-2 mt-1 border border-gray-300 rounded-md shadow-sm
                                           focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                    required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="type" name="type" class="block w-full p-2 mt-1 border border-gray-300 rounded-md shadow-sm
                                           focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                    required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="qty" name="qty" class="block w-full p-2 mt-1 border border-gray-300 rounded-md shadow-sm
                                           focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                    required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="producer" name="producer" class="block w-full p-2 mt-1 border border-gray-300 rounded-md shadow-sm
                                           focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                    required>
                            </div>
                            ...
                            <!-- Submit Button -->
                            <button type="submit" class="inline-flex justify-center px-4 py-2 text-sm font-medium text-white
